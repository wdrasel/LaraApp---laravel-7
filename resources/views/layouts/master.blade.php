...
<div id="app" class="wrapper" >
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="/img/logo.png" alt="Lara App" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview ">
                        <a href="#" class="nav-link">
                            ...
                            <p>
                                Management
                                <i class="right fas fa-angle-left indigo"></i>
...
a
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2014-2020 <a href="wd2rasel.com">WD RASEL</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
